export const works = [
  ...
  {
    title:
      "Motive Is to learn more about Solidity and how to connect smart contracts with Frontend like NextJS. And to understand how much we store in the blockchain if you visit this website please try to post a job and see how much we store in the blockchain.",
    img: "/jobBoard.png",
    date: "Jan 2022",
  ...
  {
    title:
      "w3commerce Buy together, save together, fun together and earn together with us [Winner ETHOnline]",
    img: "/w3comm.png",
    date: "Sep 2022",
  ...
  {
    title:
      "Web3-Tribes is to allow users to join different web3 tribes (communities) and gain access to content only visible to those in that specific tribe.",
  ...
  {
    title:
      "Game Build using Smart contractsuser can mint NFTs base on Unique Dna strore on the blockchian. Once user Own There NFTs they can play with by providing them Various game itemsThey can increate level of it",
  ...
  {
    title:
      "it is a really simple tool that allows anyone to send their ICX in a very simple and intuitive way to their favorite content creators.",
  ...
  {
    title:
      "Collection of my HTML,CSS and JS projects Here I used to learn basics of those things and sharing it over twitter",
  ...
  {
    title: "it is a game build using using Polygon, JS, Web3-React and NftPort",
    img: "/web3Snake.png",
    date: "Feb-Apr 2022",
  ...
  {
    title:
      "Collection of my dapps such as whitelistingDapp, MintingDapp, and ICO",
  ...
  {
    title:
      " how to connect wallet connect and Metamask using web3 react, nextJS, and make it live so anyone can use it.  wallet connect, Metamask, connect wallets Dapps ",
