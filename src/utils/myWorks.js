export const works = [
    ...
    {
        title: "Web3-Tribes is to allow users to join different web3 tribes (communities) and gain access to content only visible to those in that specific tribe.",
    ...
    {
        title: "it is a really simple tool that allows anyone to send their ICX in a very simple and intuitive way to their favorite content creators.",
